...
class SelectBreadUseCase  @Inject constructor(
    private val timerRepository: TimerRepository,
) {
    suspend operator fun invoke(targetDate: String, count: Int): Result<BreadListEntity> = timerRepository.fetchBreadList()
}
