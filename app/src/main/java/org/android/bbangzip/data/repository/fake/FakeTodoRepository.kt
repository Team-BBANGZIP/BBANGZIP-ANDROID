...
class FakeTodoRepository @Inject constructor() : TodoRepository {
    ...
    override suspend fun reorderTodo(todoId: Long, originCategoryId: Long, targetCategoryId: Long, targetCategoryColor: String, todoOrderList: List<Long>): Result<Any> {
        return Result.success(Any())
    }

    override suspend fun addTodo(categoryId: Long, content: String, targetDate: LocalDate, startTime: LocalTime?): Result<Todo> {
        return Result.success(
            Todo(
