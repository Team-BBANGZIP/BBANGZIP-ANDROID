...
constructor(
    ...
    override suspend fun postTimerCompleted(targetDate: String, count: Int): Result<CompleteBreadCountEntity> =
        runCatching {
            val response = timerRemoteDataSource.postTimerCompleted(
